...
from experiments.single_satellite_optical_cann_feedback import (
    ...
    write_single_satellite_optical_cann_feedback,
)
...
def main(argv=None):
    ...
    parser.add_argument(
        ...
        default=Path("results/cann/single_satellite_optical_feedback"),
    )
    args = parser.parse_args(argv)
    result = run_single_satellite_optical_cann_feedback(
        seed=args.seed,
        optical_fault_mode=(
            None if args.fault_mode == "none" else args.fault_mode
        ),
    )
    print(result["summary"])
    print(write_single_satellite_optical_cann_feedback(
